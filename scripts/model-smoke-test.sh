...
echo "=============================================="
echo ""
echo "After testing, save Claude Code output to a file and scan for JSON leaks:"
echo ""
echo "  ./scripts/json-leak-detector.sh <path-to-output.txt>"
echo ""
echo "Example:"
echo '  ./scripts/json-leak-detector.sh /tmp/claude-output.txt'
echo ""
echo "The detector will report:"
echo "  PASS - No raw tool-call JSON patterns detected"
echo "  FAIL - Raw tool-call JSON detected (model is NOT safe for Claude Code workflows)"
echo ""
echo "See docs/json-leak-detection.md for details on the detector and false positive limitations."
echo ""
echo "Then log the result:"
echo ""

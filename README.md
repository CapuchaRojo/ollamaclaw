...
Use Claude Code as the coding harness while routing model calls through Ollama Cloud, especially:
...
chmod +x scripts/check-env.sh scripts/launch-qwen-cloud.sh